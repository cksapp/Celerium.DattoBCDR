...
The "Celerium.DattoBCDR" team and community take all security bugs in "Celerium.DattoBCDR" seriously. Thank you for improving the security of "Celerium.DattoBCDR". We appreciate your efforts and responsible disclosure and will make every effort to acknowledge your contributions.
...
- "Celerium.DattoBCDR" will confirm the problem and determine the affected versions.
- "Celerium.DattoBCDR" will audit code to find any potential similar problems.
- "Celerium.DattoBCDR" will prepare fixes for all releases still under maintenance. These fixes will be released as fast as possible.
