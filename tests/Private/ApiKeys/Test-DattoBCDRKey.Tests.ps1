...
#Available inside It but NOT Describe or Context
    ...
    AfterAll{
        ...
        Remove-DattoBCDRBaseUri -WarningAction SilentlyContinue
...
Describe "Testing [ $commandName ] function with [ $pester_TestName ]" -Tag @('ApiKeys') {
    ...
    Context "[ $commandName ] testing function" {
        ...
        It "[ Test-DattoBCDRAPIKey ] with a bad API key should fail to authenticate" {
            Add-DattoBCDRBaseUri
            Add-DattoBCDRAPIKey -ApiKeyPublic '12345' -ApiKeySecret "Celerium.DattoBCDRAPIKey"

            $Value = Test-DattoBCDRAPIKey 3>$null
