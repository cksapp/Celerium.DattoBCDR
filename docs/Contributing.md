...
[Source Contributing Guide](https://github.com/Celerium/Celerium.DattoBCDR/blob/main/.github/CONTRIBUTING.md)
...
* **Ensure the bug was not already reported** by searching on GitHub under [Issues](https://github.com/Celerium/Celerium.DattoBCDR/issues)

* If you're unable to find an open issue addressing the problem, [open a new one](https://github.com/Celerium/Celerium.DattoBCDR/issues/new/choose)
