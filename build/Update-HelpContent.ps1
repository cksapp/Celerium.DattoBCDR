...
.PARAMETER helpDocsPath
    ...
    Reference:
        Yes - "Celerium.DattoRMM\docs"
        NO  - "Celerium.DattoRMM\Celerium.DattoRMM\docs"

    Example: "C:\Celerium\Projects\Celerium.DattoRMM\docs"

.PARAMETER csvFilePath
    Location where the tracking CSV is located including the CSV file name

    The tracking CSV should be located in "Celerium.DattoRMM\docs"
    Reference:
        Yes - "Celerium.DattoRMM\docs\Endpoints.csv"
        NO  - "Celerium.DattoRMM\Celerium.DattoRMM\docs\Endpoints.csv"

    Example: "C:\Celerium\Projects\Celerium.DattoRMM\docs\Endpoints.csv"

.PARAMETER githubPageUri
    Base url of the modules github pages

    Example: "https://celerium.github.io/Celerium.DattoRMM"
...
$downloadLink = "$githubPageUri/docs/cab"
    ...
    $moduleDescription = 'This PowerShell module acts as a wrapper for the DattoRMM API.'
