...
.EXAMPLE
    .\Invoke-HelpContent.ps1
        -moduleName Celerium.DattoBCDR
        -helpDocsPath "C:\Celerium\Projects\Celerium.DattoBCDR\docs"
        -csvFilePath "C:\Celerium\Projects\Celerium.DattoBCDR\docs\Endpoints.csv"
        -githubPageUri "https://celerium.github.io/Celerium.DattoBCDR"
...
[CmdletBinding(SupportsShouldProcess = $true)]
    param (
        ...
        [Parameter(Mandatory=$false)]
        [ValidateNotNullOrEmpty()]
        [string]$githubPageUri = "https://celerium.github.io/Celerium.DattoBCDR"
    )
