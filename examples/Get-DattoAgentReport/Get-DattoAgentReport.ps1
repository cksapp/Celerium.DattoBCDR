<#
    ...
    .DESCRIPTION
        The Get-DattoBCDRAgentReport script gets a BCDR agent report from the Datto API
    ...
    .EXAMPLE
        Get-DattoBCDRAgentReport -ApiKeyPublic 12345 -ApiKeySecret 12345
    ...
    .EXAMPLE
        Get-DattoBCDRAgentReport -ApiKeyPublic 12345 -ApiKeySecret 12345 -SerialNumber 1234567890
    ...
    .EXAMPLE
        Get-DattoBCDRAgentReport -ApiKeyPublic 12345 -ApiKeySecret 12345 -Report All
...
#Region    [ Prerequisites ]
    ...
    $ScriptName = 'Get-DattoBCDRAgentReport'
    ...
    Try {
        ...
        If(Get-Module -ListAvailable -Name Celerium.DattoBCDR) {
            Import-module Celerium.DattoBCDR -ErrorAction Stop
        }
        Else {
            Install-Module Celerium.DattoBCDR -Force -ErrorAction Stop
            Import-Module Celerium.DattoBCDR -ErrorAction Stop
        }
    }
    Catch {
    ...
    Add-DattoBCDRBaseURI -BaseUri $APIEndpoint
    Add-DattoBCDRAPIKey -ApiKeyPublic $ApiKeyPublic -ApiKeySecret $ApiKeySecret -ErrorAction Stop
...
#Region     [ Datto API ]
    ...
    Try{
        ...
        if ($SerialNumber){
            ...
            $DattoBCDR = Get-DattoBCDRDevice -SerialNumber $SerialNumber
            $DattoAgents = (Get-DattoBCDRAgent -SerialNumber $SerialNumber).items
            ...
            $DattoBCDR = (Get-DattoBCDRDevice).items
            $DattoAgentResults = ForEach ($BCDR in $DattoBCDR){

                $Agents = (Get-DattoBCDRAgent -SerialNumber $BCDR.SerialNumber).items
