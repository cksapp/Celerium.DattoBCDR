<#
    ...
    .DESCRIPTION
        The Get-DattoBCDRDeviceReport script gets an BCDR device report from the Datto API
    ...
    .EXAMPLE
        Get-DattoBCDRDeviceReport -ApiKeyPublic 12345 -ApiKeySecret 12345
    ...
    .EXAMPLE
        Get-DattoBCDRDeviceReport -ApiKeyPublic 12345 -ApiKeySecret 12345 -SerialNumber 1234567890
    ...
    .EXAMPLE
        Get-DattoBCDRDeviceReport -ApiKeyPublic 12345 -ApiKeySecret 12345 -Report All
...
#Region    [ Prerequisites ]
    ...
    $ScriptName = 'Get-DattoBCDRDeviceReport'
...
#Region     [ Datto API ]
    ...
    Try{
        ...
        if ($SerialNumber){
            $DattoDeviceResults = Get-DattoBCDRDevice -SerialNumber $SerialNumber
        }
        else{
            $DattoDeviceResults = Get-DattoBCDRDevice
